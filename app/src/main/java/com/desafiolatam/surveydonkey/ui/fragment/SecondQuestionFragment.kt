...
class SecondQuestionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.run {
            ...
            answer24.setOnCheckedChangeListener { _, checked ->
                if (checked) viewModel.addSecondAnswer(answer24.text.toString())
                else viewModel.removeSecondAnswer(answer24.text.toString())
            }

            answer25.setOnCheckedChangeListener { _, checked ->
                if (checked) viewModel.addSecondAnswer(answer25.text.toString())
                else viewModel.removeSecondAnswer(answer25.text.toString())
            }
        }
    }
