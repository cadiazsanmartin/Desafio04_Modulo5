...
class ThirdQuestionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.run {
            ...
            this!!.answer35.setOnCheckedChangeListener { _, checked ->
                if (checked) viewModel.addThirdAnswer(answer35.text.toString())
                else viewModel.removeThirdAnswer(answer35.text.toString())
            }
        }
    }
